package com.trustcoreict.demo.config;
...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-demo-cluster-cache").transport().defaultTransport()
                ...
                return () -> GlobalConfigurationBuilder
                    .defaultClusteredBuilder().defaultCacheName("infinispan-demo-cluster-cache").transport()
    ...
    public InfinispanCacheConfigurer cacheConfigurer(JHipsterProperties jHipsterProperties) {
        ...
        return manager -> {
            ...
            Stream.of(com.trustcoreict.demo.repository.UserRepository.USERS_BY_LOGIN_CACHE, com.trustcoreict.demo.repository.UserRepository.USERS_BY_EMAIL_CACHE)
